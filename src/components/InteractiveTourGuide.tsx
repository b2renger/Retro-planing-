...
export const InteractiveTourGuide: React.FC = () => {
  ...
  const stepIcons = [
    <Calendar key="1" className="w-4 h-4 text-purple-600 dark:text-purple-400" />,
    <Zap key="2" className="w-4 h-4 text-amber-600 dark:text-amber-400" />,
    <Layers key="3" className="w-4 h-4 text-blue-600 dark:text-blue-400" />,
    <FileText key="4" className="w-4 h-4 text-emerald-600 dark:text-emerald-400" />,
    <Users key="5" className="w-4 h-4 text-pink-600 dark:text-pink-400" />,
    <Cloud key="6" className="w-4 h-4 text-cyan-600 dark:text-cyan-400" />,
    <Database key="7" className="w-4 h-4 text-emerald-600 dark:text-emerald-400" />,
  ];
  ...
  if (isMinimized) {
    return (
      <div
        ...
        className="fixed bottom-5 right-5 z-50 flex items-center gap-2 bg-card border border-purple-500/40 px-3.5 py-2 rounded-2xl shadow-2xl backdrop-blur-xl animate-fadeIn"
      >
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 rounded-lg bg-purple-600/20 text-purple-700 dark:text-purple-300 flex items-center justify-center text-xs font-bold font-mono">
            {currentStepIndex + 1}
          </div>
          <div className="text-xs font-semibold text-fg max-w-[180px] truncate">
        ...
        <button
          ...
          className="p-1 rounded-lg hover:bg-elevated text-purple-700 dark:text-purple-300 text-xs flex items-center gap-1 font-medium transition-colors"
        ...
        <button
          ...
          className="p-1 rounded-lg hover:bg-elevated text-fg-muted hover:text-fg transition-colors"
          title="Exit tour"
        >
  ...
  return (
    <>
      ...
      <div
        ...
        className="fixed bottom-4 sm:bottom-6 right-3 sm:right-6 max-w-lg w-[calc(100vw-24px)] sm:w-full z-50 bg-card/95 backdrop-blur-2xl border border-purple-500/40 rounded-2xl shadow-2xl shadow-purple-950/40 text-fg flex flex-col overflow-hidden animate-fadeIn"
      >
        {/* Top Header Bar */}
        <div className="px-4 py-3 border-b border-line bg-gradient-to-r from-purple-500/10 dark:from-purple-950/50 via-card to-indigo-500/5 dark:to-indigo-950/30 flex items-center justify-between">
          <div className="flex items-center gap-2.5 min-w-0">
            <div className="w-8 h-8 rounded-xl bg-purple-600/20 border border-purple-500/30 text-purple-700 dark:text-purple-300 flex items-center justify-center shrink-0">
              <GraduationCap className="w-4 h-4" />
            </div>
            <div className="min-w-0">
              <div className="flex items-center gap-2">
                <span className="text-[10px] uppercase font-mono font-bold tracking-wider text-purple-700 dark:text-purple-300 bg-purple-500/20 px-2 py-0.5 rounded-full border border-purple-500/30">
              ...
              <h3 className="text-xs sm:text-sm font-bold text-fg truncate mt-0.5">
                {currentStep.title}
              </h3>
            </div>
          </div>
        ...
        <div className="p-4 space-y-3 max-h-[50vh] overflow-y-auto text-xs">
          ...
          {demoNotice && (
            <div className="p-2.5 rounded-xl bg-purple-500/20 border border-purple-500/40 text-purple-800 dark:text-purple-200 text-xs flex items-center gap-2 animate-pulse">
          ...
          <div className="bg-purple-500/10 dark:bg-purple-950/30 border border-purple-500/25 rounded-xl p-3 space-y-1.5">
          ...
          {currentStep.keyBenefits && currentStep.keyBenefits.length > 0 && (
            <div className="space-y-1 pt-1">
              ...
              <div className="grid grid-cols-1 gap-1 text-[11px] text-fg-muted">
        ...
        {/* Footer Actions */}
        <div className="p-3 bg-elevated border-t border-line flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="px-2.5 py-2 rounded-xl bg-elevated hover:bg-line disabled:opacity-30 text-fg-muted text-xs font-medium flex items-center gap-1 transition-colors"
            >
